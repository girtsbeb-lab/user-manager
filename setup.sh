...
docker compose exec app bash -c "cp /tmp/laravel10/app/Http/Middleware/*.php /var/www/app/Http/Middleware/"
docker compose exec app bash -c "rm -rf /var/www/app/Http/Middleware/Middleware"
